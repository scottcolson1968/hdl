...
set MAX_RX_NUM_OF_LANES 6

source $ad_hdl_dir/library/jesd204/scripts/jesd204.tcl

# adc peripherals

ad_ip_instance axi_adxcvr axi_ad9694_rx_xcvr [list \
  NUM_OF_LANES $MAX_RX_NUM_OF_LANES \
  QPLL_ENABLE 1 \
  TX_OR_RX_N 0 \
  SYS_CLK_SEL 3 \
  OUT_CLK_SEL 3 \
...
adi_axi_jesd204_rx_create axi_ad9694_rx_jesd $RX_NUM_OF_LANES
ad_ip_parameter axi_ad9694_rx_jesd/rx CONFIG.SYSREF_IOB false

ad_ip_instance util_cpack2 util_ad9694_rx_cpack [list \
...
ad_ip_instance axi_dmac axi_ad9694_rx_dma [list \
  DMA_TYPE_SRC 2 \
  DMA_TYPE_DEST 0 \
  CYCLIC 0 \
...
# Rx
ad_connect ad9694_rx_device_clk rx_core_clk_0
...
for {set i 0} {$i < $MAX_RX_NUM_OF_LANES} {incr i} {
  ...
  ad_xcvrpll  axi_ad9694_rx_xcvr/up_pll_rst util_ad9694_xcvr/up_cpll_rst_$ch
}

ad_xcvrpll  axi_ad9694_rx_xcvr/up_pll_rst util_ad9694_xcvr/up_qpll_rst_*

# connections (adc)

ad_connect $sys_cpu_resetn axi_ad9694_rx_dma/m_dest_axi_aresetn
ad_connect dma_clk_wiz/clk_out1 axi_ad9694_rx_dma/m_dest_axi_aclk
ad_connect util_ad9694_rx_cpack/packed_fifo_wr axi_ad9694_rx_dma/fifo_wr
ad_connect util_ad9694_rx_cpack/packed_sync axi_ad9694_rx_dma/sync

ad_connect $sys_cpu_clk dma_clk_wiz/clk_in1
ad_connect $sys_cpu_resetn dma_clk_wiz/resetn

ad_connect ad9694_rx_device_clk rx_ad9694_tpl_core/link_clk
ad_connect ad9694_rx_device_clk util_ad9694_rx_cpack/clk
ad_connect ad9694_rx_device_clk axi_ad9694_rx_dma/fifo_wr_clk
ad_connect ad9694_rx_device_clk_rstgen/peripheral_reset util_ad9694_rx_cpack/reset

ad_connect axi_ad9694_rx_jesd/rx_sof rx_ad9694_tpl_core/link_sof
ad_connect axi_ad9694_rx_jesd/rx_data_tdata rx_ad9694_tpl_core/link_data
ad_connect axi_ad9694_rx_jesd/rx_data_tvalid rx_ad9694_tpl_core/link_valid

ad_connect rx_ad9694_tpl_core/adc_valid_0 util_ad9694_rx_cpack/fifo_wr_en
ad_connect rx_ad9694_tpl_core/adc_dovf util_ad9694_rx_cpack/fifo_wr_overflow
for {set i 0} {$i < $RX_NUM_OF_CONVERTERS} {incr i} {
  ad_connect rx_ad9694_tpl_core/adc_enable_$i util_ad9694_rx_cpack/enable_$i
  ad_connect rx_ad9694_tpl_core/adc_data_$i util_ad9694_rx_cpack/fifo_wr_data_$i
}

# interconnect (cpu)

ad_cpu_interconnect 0x44A00000 rx_ad9694_tpl_core
ad_cpu_interconnect 0x44A60000 axi_ad9694_rx_xcvr
ad_cpu_interconnect 0x44AA0000 axi_ad9694_rx_jesd
ad_cpu_interconnect 0x7c400000 axi_ad9694_rx_dma

ad_mem_hp0_interconnect $sys_cpu_clk sys_ps8/S_AXI_HP0
ad_mem_hp0_interconnect $sys_cpu_clk axi_ad9694_rx_xcvr/m_axi
