...
if {$sys_zynq == 0 || $sys_zynq == 1} {
  ...
  # the data offload external synchronization is not used
...
if {$sys_zynq == 0 || $sys_zynq == 1} {
    ...
    # When data offload deasserts tready (buffer full), the cpack is held in reset
    # to ensure the samples are correctly aligned after a reassertion. This approach
    # was chosen because the cpack does not support backpressure natively.
