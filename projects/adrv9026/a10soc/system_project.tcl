...
set_location_assignment PIN_R33 -to rx_serial_data[0]      ; ## A2   FMCA_DP01_M2C_P     GXBL1H_RX_CH1p,GXBL1H_REFCLK1p  (rx_serial_data_p[0])
set_location_assignment PIN_R32 -to "rx_serial_data[0](n)" ; ## A3   FMCA_DP01_M2C_N     GXBL1H_RX_CH1n,GXBL1H_REFCLK1n  (rx_serial_data_n[0])
set_location_assignment PIN_T31 -to rx_serial_data[1]      ; ## C6   FMCA_DP00_M2C_P     GXBL1H_RX_CH0p,GXBL1H_REFCLK0p  (rx_serial_data_n[1])
set_location_assignment PIN_T30 -to "rx_serial_data[1](n)" ; ## C7   FMCA_DP00_M2C_N     GXBL1H_RX_CH0n,GXBL1H_REFCLK0n  (rx_serial_data_p[1])
...
set_location_assignment PIN_P31 -to rx_serial_data[3]      ; ## A10  FMCA_DP03_M2C_P     GXBL1H_RX_CH3p,GXBL1H_REFCLK3p  (rx_serial_data_p[3])
set_location_assignment PIN_P30 -to "rx_serial_data[3](n)" ; ## A11  FMCA_DP03_M2C_N     GXBL1H_RX_CH3n,GXBL1H_REFCLK3n  (rx_serial_data_n[3])

set_location_assignment PIN_M39 -to tx_serial_data[0]      ; ## A22  FMCA_DP01_C2M_P     GXBL1H_TX_CH1p  (tx_serial_data_p[2])
set_location_assignment PIN_M38 -to "tx_serial_data[0](n)" ; ## A23  FMCA_DP01_C2M_N     GXBL1H_TX_CH1n  (tx_serial_data_n[2])
set_location_assignment PIN_N37 -to tx_serial_data[1]      ; ## C2   FMCA_DP00_C2M_P     GXBL1H_TX_CH0p  (tx_serial_data_n[3])
set_location_assignment PIN_N36 -to "tx_serial_data[1](n)" ; ## C3   FMCA_DP00_C2M_N     GXBL1H_TX_CH0n  (tx_serial_data_p[3])
