...
adi_ip_properties_lite ethernet_vcu118

set cc [ipx::current_core]

set_property display_name "Corundum Ethernet VCU118" $cc
set_property description "Corundum Ethernet Core IP" $cc
set_property company_url {https://analogdevicesinc.github.io/hdl/library/corundum/ethernet/ethernet_vcu118} [ipx::current_core]
