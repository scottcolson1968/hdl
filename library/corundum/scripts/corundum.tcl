...
ad_ip_instance corundum_core corundum_core [list \
  ...
  DMA_ADDR_WIDTH_APP $DMA_ADDR_WIDTH \
  RAM_SEL_WIDTH_APP $RAM_SEL_WIDTH \
  RAM_SEG_COUNT_APP $RAM_SEG_COUNT \
  RAM_SEG_DATA_WIDTH_APP $RAM_SEG_DATA_WIDTH \
  RAM_SEG_BE_WIDTH_APP $RAM_SEG_BE_WIDTH \
  RAM_SEG_ADDR_WIDTH_APP $RAM_SEG_ADDR_WIDTH \
  AXIS_SYNC_KEEP_WIDTH_APP $AXIS_SYNC_KEEP_WIDTH \
  AXIS_SYNC_TX_USER_WIDTH_APP $AXIS_SYNC_TX_USER_WIDTH \
  AXIS_SYNC_RX_USER_WIDTH_APP $AXIS_SYNC_RX_USER_WIDTH \
  AXIS_IF_KEEP_WIDTH_APP $AXIS_IF_KEEP_WIDTH \
  AXIS_IF_TX_ID_WIDTH_APP $AXIS_IF_TX_ID_WIDTH \
  AXIS_IF_RX_ID_WIDTH_APP $AXIS_IF_RX_ID_WIDTH \
  AXIS_IF_TX_DEST_WIDTH_APP $AXIS_IF_TX_DEST_WIDTH \
  AXIS_IF_RX_DEST_WIDTH_APP $AXIS_IF_RX_DEST_WIDTH \
  AXIS_IF_TX_USER_WIDTH_APP $AXIS_IF_TX_USER_WIDTH \
  AXIS_IF_RX_USER_WIDTH_APP $AXIS_IF_RX_USER_WIDTH \
]
...
switch $board {
  ...
  XCVU11P {
    ad_ip_instance ethernet_xcvu11p ethernet_core [list \
...
if {[string equal $board "K26"] || [string equal $board "ADRV9009ZU11EG"]} {
